...
The system automatically turns the fan **ON** when the ambient temperature exceeds **23 °C** and turns it **OFF** when the temperature falls below the threshold using hysteresis.
...
- Prevents damage to the transistor and MCU  
...
- If temperature **≥ 23 °C**:
  ...
  - Motor direction is set  
  - PWM enabled for speed control  
  - Fan speed adjusted using potentiometer  
